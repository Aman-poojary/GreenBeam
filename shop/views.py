...
def checkout(request):
    ...
    if request.method=="POST":
        ...
        if(len(items_json)>3):
            ...
            update = OrderUpdate(order_id = order.order_id,user=request.user, update_desc = "The order has been placed,Track your Order using tracker.")
            update.save()
            ...
            messages.success(request, 'Order placed successfully, track your order using tracker.Thank you for shopping')
            cartClear = True
